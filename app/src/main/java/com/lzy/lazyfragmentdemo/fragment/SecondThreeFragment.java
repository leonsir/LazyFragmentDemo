...
public class SecondThreeFragment extends BaseFragmentTwo {
    /**
     * 由子类实现
     *
     * @return 返回子类的布局id
    ...
    @Override
    int getLayoutId() {
        return R.layout.fragment_second_three;
    }
     ...
     */
    @Override
    boolean setFragmentTarget() { return true; }
